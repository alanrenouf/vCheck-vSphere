...
Get-VIEventPlus -Start ($Date).AddDays(-$HAVMresetold) -Type Info | Where-Object {$_.FullFormattedMessage -match "reset due to a guest OS error"} | Select-Object CreatedTime,FullFormattedMessage | Sort-Object CreatedTime -Descending
