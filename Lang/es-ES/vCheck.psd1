...
ConvertFrom-StringData @' 
    ...
    setupMsg11  =
    configMsg01 = Despues de haber exportado la nueva configuración desde el interfaz de configuración,
    configMsg02  = importa el fichero CSV con la configuración utilizando Import-vCheckSettings -csvfile c:\\path\\to\\vCehckSettings.csv
    ...
    repTime     = Este informe tardó {0} minutos en ejecutar todos los checks, completado en {1} en {2}
    repPRTitle = Informe de Plugin
    repTTRTitle = Tiempo de Ejecución
    slowPlugins = Los siguientes plugins tardarón más de {0} segundos en ejecturase, quizá haya una forma de optimizarlos o de desactivarlos si no son necesarios    
